...
metrics_title = evaluator.evaluate(qrels=qrels, results=retrieved_results_title, k_values=[1, 3, 5, 10])
metrics_text = evaluator.evaluate(qrels=qrels, results=retrieved_results_text, k_values=[1, 3, 5, 10])
metrics_both = evaluator.evaluate(qrels=qrels, results=retrieved_results_both, k_values=[1, 3, 5, 10])
...
with open("results_v2/results_title_bert.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(all_results_title) + "\n")

with open("results_v2/results_text_bert.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(all_results_text) + "\n")

with open("results_v2/results_both_bert.txt", "w", encoding="utf-8") as f:
